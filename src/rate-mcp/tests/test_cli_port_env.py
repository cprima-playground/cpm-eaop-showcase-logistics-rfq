...
legacy-compat fallbacks (containerization-consolidation milestone --
qms-mcp was found missing this fallback, rate-mcp too; this asserts all
three MCP servers agree)."""

from rate_mcp.cli import _resolve_host_port
