...
def _resolve_host_port() -> tuple[str, int]:
    ...
    matches tms-mcp/rate-mcp/qms-mcp."""
    host = os.environ.get("SERVICE_HOST", os.environ.get("A2A_HOST", "127.0.0.1"))
    port = int(os.environ.get("SERVICE_PORT", os.environ.get("A2A_PORT", "8107")))
    return host, port
...
def main() -> None:
    ...
    configure_observability(
        service_name="approval-mcp", canonical_id=settings.EXPECTED_CANONICAL_ID,
