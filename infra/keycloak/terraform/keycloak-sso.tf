...
resource "keycloak_openid_client" "ops_dashboard_web" {
  ...
  valid_post_logout_redirect_uris = ["http://localhost:8006", "https://ops-dashboard.eaop-logistics.localhost"]
  web_origins                    = ["http://localhost:8006", "https://ops-dashboard.eaop-logistics.localhost"]
}
